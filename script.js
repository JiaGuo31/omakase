document.addEventListener('DOMContentLoaded', () => {
    ...
    var topics = ['History','Science','Technology','Psychology',
                    'Business','Environment','Health','Self-help'];
    ...
    const topicOptions = {
        ...
        'Business': ['Entrepreneurship', 'Management', 'Marketing', 'Finance'],
        'Psychology': ['Cognitive Psychology', 'Social Psychology', 'Developmental Psychology', 'Clinical Psychology'],
        'Environment': ['Climate Change', 'Conservation', 'Sustainability', 'Environmental Policy'],
        'Health': ['Nutrition', 'Public Health', 'Medical Research', 'Mental Health']
//        'Genre A': ['A1', 'A2', 'A3', 'A4'],
//        'Genre B': ['B1', 'B2', 'B3', 'B4'],
//        'Genre C': ['C1', 'C2', 'C3', 'C4'],
//        'Genre D': ['D1', 'D2', 'D3', 'D4']
...
//            }, 1000);
    ...
    function showRecommendations(state, data) 
    {
        ...
        if (state === true) 
        {
            ...
            html += "<div class=\"menu-item\" onclick=\"window.open('https://go.nlb.gov.sg/m-link/details?type=ebook&id=91051799-b375-4087-8e8d-a7bfe93e5efe&utm_source=online&utm_campaign=blackbox_omakase&utm_medium=website&utm_content=ebook2','mywindow');\" style=\"cursor: pointer;\">";
                html += "<div class=\"menu-header\">";
                    html += "Appetiser: <b>Introduction and Fundamentals</b>";
                html += "</div>";
            ...
            html += "<div class=\"menu-item\" onclick=\"window.open('https://go.nlb.gov.sg/m-link/details?type=ebook&id=91051799-b375-4087-8e8d-a7bfe93e5efe&utm_source=online&utm_campaign=blackbox_omakase&utm_medium=website&utm_content=ebook2','mywindow');\" style=\"cursor: pointer;\">";
                html += "<div class=\"menu-header\">";
                    html += "Main Course: <b>Hands-On Learning</b>";
                html += "</div>";
                html += "<div class=\"menu-img\">";
            ...
            html += "<div class=\"menu-item\" onclick=\"window.open('https://go.nlb.gov.sg/m-link/details?type=ebook&id=91051799-b375-4087-8e8d-a7bfe93e5efe&utm_source=online&utm_campaign=blackbox_omakase&utm_medium=website&utm_content=ebook2','mywindow');\" style=\"cursor: pointer;\">";
                html += "<div class=\"menu-header\">";
                    html += "Dessert: <b>One Step Further</b>";
                html += "</div>";
                html += "<div class=\"menu-img\">";
