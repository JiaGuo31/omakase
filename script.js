...
//            }, 1000);
    ...
    {
        var topic = userChoices.step2;
        var subTopic = userChoices.step3;
        var level = userChoices.step4;
            
        document.getElementById('you-have-selected').innerHTML = 'Thanks for letting me know what you are looking for!'
                + '<br/>You have selected <b>'
                + topic + ' >> ' + subTopic + '</b> at <b>' + level + '</b> level.';
        
        var arr = [];
        
        if (data !== null && data !== '')
        {
            arr = data.reason.split('.');
        ...
        else
        {
            ...
            document.getElementById('bottom-box').classList.add('hidden');
        }
        ...
        for (var i = 1 ; i <= arr.length ; i++)
        {
            ...
            if (i%2 === 0) sentence += '<br/><br/>';
        }
        
        document.getElementById('reason-box').innerHTML = sentence;
...
//            recommendationList.appendChild(li);
        ...
        document.getElementById("id_check").innerHTML = 'Password 1: ' + randomIdOne + ', Password 2 : ' + randomIdTwo;
    }
